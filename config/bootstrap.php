 ...
 */
mb_internal_encoding(Configure::read('App_old.encoding'));

/*
 * Set the default locale. This controls how dates, number and currency is
 * formatted and sets the default language to use for translations.
 */
ini_set('intl.default_locale', Configure::read('App_old.defaultLocale'));
...
if (PHP_SAPI === 'cli') {
    ...
    // Configure::write('App_old.fullBaseUrl', php_uname('n'));
 ...
 */
$fullBaseUrl = Configure::read('App_old.fullBaseUrl');
if (!$fullBaseUrl) {
    /*
