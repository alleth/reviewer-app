    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-12">
            <div className="card p-6 sm:p-10">
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">4. User Conduct</h2>
                    <p className="text-gray-600">You agree to use the Platform responsibly and not to:</p>
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">6. Payment Terms</h2>
                    <p className="text-gray-600">
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">7. Privacy</h2>
                    <p className="text-gray-600">
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">11. Dispute Resolution</h2>
                    <p className="text-gray-600">
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">12. Changes to Terms</h2>
                    <p className="text-gray-600">
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">13. Third-Party Links</h2>
                    <p className="text-gray-600">
                ...
                <section className="mb-6">
                    <h2 className="mb-2 text-lg font-semibold text-gray-900">14. Force Majeure</h2>
                    <p className="text-gray-600">
